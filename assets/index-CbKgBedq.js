...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function L_(n,e,t){const i=new Float32Array(Ri),r=new Z(0,1,0);return new Kn({name:"SphericalGaussianBlur",defines:{n:Ri,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:ca(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function ou(){return new Kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ca(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function lu(){return new Kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ca(),fragmentShader:`
...
`].filter(Lr).join(`
`)),a=al(a),a=vu(a,t),a=Su(a,t),o=al(o),o=vu(o,t),o=Su(o,t),a=Mu(a),o=Mu(o),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
